                ...
                <div class="row bottom5">
                        ...
                        <div class="row">
                            ...
                            <div class="row">                                
                                <div id="botonesSolicitud" class="col-12 d-grid gap-2">  
                                    <?php if($relacion == 0):?>
                                        <button type="button" onclick="enviarSolicitud()" class="btn btn-primary bottom15 btn-success text-start"><span class="fa fa-user-group"></span> Enviar solicitud de contacto</button>
                                    <?php elseif($relacion == 1):?>
                                        <button type="button" onclick="cancelarSolicitud()" class="btn btn-primary bottom15 btn-secondary text-start"><span class="fa fa-user-group"></span> Cancelar solicitud</button>
                                    <?php elseif($relacion == 2):?>
                                        <button type="button" onclick="eliminarS()" class="btn bottom15 btn-danger text-start"><span class="fa fa-user-group"></span> Eliminar contacto</button>
                    ...
                    <div class="col-md-7">            
                        ...
                        <div class="card bottom30">                
                            <div class="card-body"> 
                                <?php foreach($proveedor as $prove):?>
                                    <h4><b>Informacion de proveedor:</b></h4>
...
<script>
    ...
    function enviarSolicitud(){
        ...
        event.preventDefault();
            $.ajax ({
                type: "get",
                url: "<?php echo base_url('/enviarSolicitud')?>/"+proveedor,
    ...
    function cancelarSolicitud(){
        ...
        event.preventDefault();
            $.ajax ({
                type: "get",
                url: "<?php echo base_url('/cancelarSolicitud')?>/"+proveedor,
                success: function(data){
                    if(data == 1){
                        $("#botonesSolicitud").load(location.href+" #botonesSolicitud>*","");
                    }else{
                        alert('Error en la cancelacion ');
                    }
                },
                error: function(){
                    alert("Error en la llamada ajax, de cancelar solicitud de contacto");
                }
    ...
    function eliminarS(){
        var pathname = window.location.pathname;
        var pathArray = pathname.split('/');
        var idProveedor = parseInt(pathArray[ pathArray.length -1 ]);
        event.preventDefault();
        $.ajax ({
            type: "get",
