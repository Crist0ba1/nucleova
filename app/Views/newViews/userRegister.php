<div class="modal fade" id="modalRegister2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><i id="iTitulo" class="fa fa-plus"></i> Informacion de usuario</h5>
      ...
      <div class="modal-body">
        <div class="col-10">
			...
			<br>
			<div><img style="width: 150px; max-width:100%; height:100%; max-height:150px;" 
...
<script>
    <?php if($verModal == 1):?>        
        alert('esta mal el llamado al modal');
        //var myModal = new bootstrap.Modal($('#modalRegister2'))myModal.show()
        new bootstrap.Modal($('#modalRegister2')).show();

        alert("ESTO TIENE QUE SALIR SI LLEGA");
    <?php else:?>
        alert('viene mal la wea');
    <?php endif;?>
</script>
<script> 
