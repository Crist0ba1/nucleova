                ...
                <div class="card border-white">
                    <div class="card-body">
                        <div class="col">
                            ...
                            <div class="row"><button type="button" class="btn btn-primary btn-block bottom10 btn-purple text-start" disabled><span class="fa-regular fa-pencil"></span> Editar</button></div>
                            ...
                            <div class="row"><button type="button" class="btn btn-primary btn-block bottom10 btn-success text-start" disabled><span class="fa-regular fa-check"></span> Finalizado</button></div>
                        </div>
                    </div>
                </div>
            </div>
