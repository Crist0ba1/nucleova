            ...
            <div class="container">
              <a class="navbar-brand" href="<?php echo base_url('/');?>">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url('')?>/solicitudes">Solicitudes <!--span class="badge rounded-pill bg-danger">5</span--></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url('')?>/mis_clientes">Mis Clientes <!--span class="badge rounded-pill bg-danger">2</span--></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url('')?>/mis_requerimientos">Requerimientos <!--span class="badge rounded-pill bg-danger">10</span--></a>
                    </li>
                    <li>
