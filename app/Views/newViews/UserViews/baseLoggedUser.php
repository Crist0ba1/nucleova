...
<html lang="en">
    <head>
        ...
        <link href="../assets/bootstrap4/css/bootstrap.min.css" rel="stylesheet" type="text/css">
        ...
        <nav class="navbar navbar-expand-sm navbar-dark bottom30 bg-blue">
            <div class="container">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">Solicitudes <span class="badge rounded-pill bg-danger">5</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Mis Clientes <span class="badge rounded-pill bg-danger">2</span></a>
                    </li>
                    <li class="nav-item">
