                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <form action="" enctype="multipart/form-data">
                                <img id="preload" class="img-fluid">
                                <input type="file" class="form-control form-control-user" id="file1" name="file1"
                                            placeholder="Imagen"  >
                                <button type="button" id="subirImagen" class="btn btn-secondary">Cargar imagen</button>
                            </form>
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">REgister buscador!</h1>
                            </div>
...
<script>
    $('#subirImagen').click(function(){
        $.ajax({  
            url:<?php echo base_url('registrarPersona/fileUpload'); ?>,
            type: 'post',
            dataType:'json',
            data: formData,
